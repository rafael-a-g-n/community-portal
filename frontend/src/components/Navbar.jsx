...
import { PlusCircle, ClipboardList, Menu, X } from 'lucide-react';
            ...
            <div className="px-4 py-4 space-y-1">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="block px-4 py-3 text-sm font-medium text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-xl transition-colors"
                >
                  {link.label}
                </Link>
              ))}
