    ...
    return (
      <div className="max-w-md mx-auto px-4 py-20 text-center">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">{t('contact.thankYou')}</h2>
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      >
        <div className="p-8 sm:p-12">
          <div className="mb-10">
            <h1 className="text-3xl font-extrabold text-gray-900 mb-2">{t('contact.title')}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">
                {t('contact.nameLabel')} <span className="text-gray-400 font-normal">({t('common.optional')})</span>
              </label>
              <input
                type="text"
                value={formData.name}
