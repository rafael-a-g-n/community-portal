    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full text-sm font-medium hover:border-indigo-300 transition-colors"
        >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {report.latitude && report.longitude ? (
                      <a
                        ...
                        className="inline-flex items-center gap-1 mt-1 text-sm text-indigo-600 hover:text-indigo-500"
                      >
                        <MapPin className="w-3.5 h-3.5" />
                        {report.address || `${report.latitude}, ${report.longitude}`}
                      </a>
                    ) : (
                      <p className="text-sm text-gray-400 mt-1">{t('home.noLocation')}</p>
                    )}
                  </div>
                </div>
              </motion.div>
