      ...
      >
        <div className="p-8 sm:p-12">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-extrabold text-gray-900 mb-2">{t('track.title')}</h1>
            <p className="text-gray-500">{t('track.subtitle')}</p>
          </div>
          ...
          <form onSubmit={handleTrack} className="mb-8" data-testid="track-form">
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all text-sm font-mono"
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="flex items-start gap-3 p-4 bg-red-50 border border-red-100 rounded-xl mb-6"
          ...
          {searched && !loading && !error && !report && (
            <div className="text-center py-8 text-gray-400" data-testid="track-empty">
